  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.recommandedContainer}>
        <View style={styles.recommandedElement}>
          <Text style={styles.recommandedText}>Recommanded dishes</Text>
        </View>
        <FlatList
          data={DATA}
          renderItem={({ item }) => 
